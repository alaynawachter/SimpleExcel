Simple_Excel_Tools is my base Excel Add in. It is designed in mind for visual data analysis in excel, but can be used by anyone. Free to use, change, distribute.
Add on contains:
